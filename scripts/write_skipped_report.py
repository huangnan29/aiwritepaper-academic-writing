...
VALID_CATEGORIES = {"evidence", "figure", "formula", "delivery", "quality"}
...
def main() -> int:
    ...
    payload = {"schema_version":"1.0","status":a.skip_status,"category":a.category,"mode":a.mode,"reason":a.reason,"inherited":inherited,"input_sha256":hashes,"verifier":{"name":script.name,"version":"1.9.1","sha256":sha256(script),"generated_at":datetime.now().astimezone().isoformat(timespec="seconds")}}
